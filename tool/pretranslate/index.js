 ...
 * @params {string} para
 * @example
 *  appendTranslation([['中文', 'Chinese'], ['类型别名', 'type alias']], "Foo bar Type Alias baz")
 *  // => "Foo bar Type Alias baz\ntype alias: 类型别名"
 *  appendTranslation([['中文', 'Chinese'], ['类型别名', 'type alias']], "Foo bar Type alias baz")
 *  // => "Foo bar Type alias baz\ntype alias: 类型别名"
 *  appendTranslation([['中文', 'Chinese'], ['类型别名', 'type alias']], "Foo bar Type\n alias baz")
 *  // => "Foo bar Type\n alias baz"
 *  appendTranslation([['中文', 'Chinese'], ['类型别名', 'type alias']], "Chinese bar Type alias baz")
 *  // => "Chinese bar Type alias baz\nChinese: 中文\ntype alias: 类型别名"
 */
 ...
 * @example
 *  parseDictionary("foo\nbar\n<!--|Translated|Original|-->\n|:----|----:|\n| 类型别名| type alias |\n|  自定义类型  | custom types|\nbazbar\nbazbaz")
 *  // => [["类型别名", "type alias"], ["自定义类型", "custom types"]]
 */
 ...
 *  trContents('|翻译|原文|')
 *  // => ['翻译', '原文']
 *  trContents('|中文|Chinese|')
 *  // => ['中文', 'Chinese']
 *  trContents('  |  翻译   |    原文 |  ')
 *  // => ['翻译', '原文']
 *  trContents('翻译|原文|') === null
 *  // => true
 *  trContents('|翻译|原文') === null
 *  // => true
 *  trContents('<!-- |  翻译   |    原文 |  -->')
